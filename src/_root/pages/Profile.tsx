...
const Profile = () => {
  ...
  const handleFollow = () => {
    // Your logic to follow/unfollow the user
    setIsFollowing(!isFollowing); // Toggle follow status
  };

  return (
    <div className="profile-container bg-dark-2">
        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <div className="flex gap-8 mt-10 items-center justify-center xl:justify-start flex-wrap z-20">
              ...
              <StatBlock value={20} label="Followers" /> {/* Update follower count */}
              <StatBlock value={20} label="Following" /> {/* Update following count */}
            </div>
